...
export const earlyAccessApplications = pgTable(
  ...
  (t) => [
    check("early_access_status_check", t.status.in(["pending", "needs_info", "approved", "rejected"])),
    check("early_access_package_check", t.requestedPackageSlug.in(["umkm", "freelancer", "creator", "creator-seller"])),
